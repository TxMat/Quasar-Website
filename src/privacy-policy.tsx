            ...
            ">Privacy Policy</h1>
                <div className={"w-10/12"}>
                    <div className="flex flex-col text-justify gap-1 mb-6">
                        <h1 className={"text-2xl mb-2"}>Privacy Policy for Quasar Entertainment</h1>
                        <p>At portfolio, accessible from
                            https://sites.google.com/view/ethan-perrod/jeux-2023/projet-personnel/memorycards?authuser=0,
                            one of our main priorities is the privacy of our visitors. This Privacy Policy document
                            contains types of information that is collected and recorded by portfolio and how we use
                            it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in portfolio. This
                            policy is not applicable to any information collected offline or via channels other than
                            this website.</p>
                        <h2 className={"text-2xl mb-2 mt-4"}>Consent</h2>
                        <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
                        <h2 className={"text-2xl mb-2 mt-4"}>Information we collect</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>How we use your information</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>Log Files</h2>
                        <p>portfolio follows a standard procedure of using log files. These files log visitors when they
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>Cookies and Web Beacons</h2>
                        <p>Like any other website, portfolio uses "cookies". These cookies are used to store information
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>Advertising Partners Privacy Policies</h2>
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on portfolio,
                            ...
                            visit.</p>
                        <p>Note that portfolio has no access to or control over these cookies that are used by
                            third-party advertisers.</p>
                        <h2 className={"text-2xl mb-2 mt-4"}>Third Party Privacy Policies</h2>
                        <p>portfolio's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>CCPA Privacy Rights (Do Not Sell My Personal
                            Information)</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>GDPR Data Protection Rights</h2>
                        ...
                        <p>If you make a request, we have one month to respond to you. If you would like to exercise any
                            of these rights, please contact us.</p>
                        <h2 className={"text-2xl mb-2 mt-4"}>Children's Information</h2>
                        <p>Another part of our priority is adding protection for children while using the internet. We
                            encourage parents and guardians to observe, participate in, and/or monitor and guide their
                            online activity.</p>
                        <p>portfolio does not knowingly collect any Personal Identifiable Information from children
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>Changes to This Privacy Policy</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4"}>Contact Us</h2>
