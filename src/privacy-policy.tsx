    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center justify-center my-auto">
                <h1 className="mt-16 text-4xl font-bold pb-32 bg-gradient-to-br from-pink-500 via-purple-600 to-red-900 text-transparent bg-clip-text filter drop-shadow-2xl
            ">Privacy Policy</h1>
                <div className={"w-10/12"}>
                    <div className="flex flex-col text-justify gap-1 mb-6">
                        <div className={"text-sm text-gray-500 italic"}>
                            ...
                            <p>We use Your Personal data to provide and improve the Service. By using the Service, You
                                agree
                                to
                                the collection and use of information in accordance with this Privacy Policy. This
                                Privacy
                        ...
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Interpretation and
                            Definitions</h2>
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Interpretation</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Definitions</h3>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Application</strong> refers to MemoryCards, the software program provided by
                                    the
                                    Company.</p>
                            </li>
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                    this Agreement) refers to MemoryCards.</p>
                            </li>
                            <li>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Collecting and Using Your
                            Personal Data</h2>
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Types of Data Collected</h3>
                        <h4>Personal Data</h4>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Use of Your Personal Data</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Retention of Your Personal
                            Data</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Transfer of Your Personal
                            Data</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Delete Your Personal Data</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Disclosure of Your Personal
                            Data</h3>
                        ...
                        <h3 className={"text-xl mb-2 mt-2 underline decoration-blue-600"}>Security of Your Personal
                            Data</h3>
                        <p>The security of Your Personal Data is important to Us, but remember that no method of
                            ...
                            absolute security.</p>
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Children's Privacy</h2>
                        ...
                        <p>If We need to rely on consent as a legal basis for processing Your information and Your
                            ...
                            use
                            that information.</p>
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Links to Other
                            Websites</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Changes to this Privacy
                            Policy</h2>
                        ...
                        <h2 className={"text-2xl mb-2 mt-4 underline decoration-fuchsia-700"}>Contact Us</h2>
                        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                        <ul>
                            <li>
                                <p>By email: quasar.entmt@gmail.com</p>
                            </li>
                            <li>
                                <p>By visiting this page on our website: <a href="https://quasar-entertainment.tech/"
                                                                            rel="external nofollow noopener"
                                                                            target="_blank">https://quasar-entertainment.tech/</a>
                                </p>
                            </li>
                        </ul>
                    </div>
